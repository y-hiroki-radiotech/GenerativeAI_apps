...
# *ノードの定義
# グラフの各ノードを関数として定義する。各ノードは現在のステートを受け取り、ステートの更新差分を辞書型で返します
...
# *answeringノードの実装
# 選定されたロールに基づいて回答を行うansweringノードでは、ロールに基づいた回答を提供するようにプロンプトを設定する.
# LLMによる処理の後、応答をmessagesリストに追加する
...
# *条件付きエッジの定義
# ckeckノードから次のノードへの遷移に条件付きエッジを定義
